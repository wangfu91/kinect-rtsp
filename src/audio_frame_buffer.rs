...
mod tests {
    ...
    fn test_default_audio_frame_buffer() {
        ...
        assert_eq!(buffer_i16._len(), 0);
        assert_eq!(buffer_f32._len(), 0);
    }
    ...
    fn test_pop_frame_sufficient_samples() {
        ...
        assert_eq!(buffer._len(), 4); // Remaining samples
    }
    ...
    fn test_pop_frame_insufficient_samples() {
        ...
        assert_eq!(buffer._len(), 3); // No samples consumed
    }
    ...
    fn test_pop_frame_exact_samples() {
        ...
        let frame = frame.unwrap();
        assert_eq!(frame, vec![1, 2, 3, 4]);
        assert_eq!(buffer._len(), 0); // All samples consumed
    }
